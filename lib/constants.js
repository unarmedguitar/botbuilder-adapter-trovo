module.exports = {
    selectors: {
        ...
        followButton: '"Follow"',
        onlineUsers: '#__layout > div > section > div.header-right > svg > use',
        closeOnlineUsers: '#__layout > div > section > div.gift-rank > svg > use'
    },
    chatType: {
        message: 0,
        streamer: 1,
        ...
        event: 9999, // This is not part of Trovo and is just a placeholder
    }
};